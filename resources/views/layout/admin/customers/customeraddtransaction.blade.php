...
@section('template_title')
    {{__('message.page.addTransaction')}}
@endsection
        ...
        <div class="content-wrapper">
            <div class="content-header row">
                <div class="content-header-left col-md-6 col-12 mb-2 breadcrumb-new">
                    <h2 class="content-header-title mb-0 d-inline-block">{{__('message.page.addTransaction')}}</h2>
                </div>
            </div>
                        ...
                        <div class="col-xl-3 col-lg-4 col-md-4 col-12">
                            <div class="card card border-teal border-lighten-2"   >
                                ...
                                <div class="list-group list-group-flush">
                                    <a href="#" id="phone" class="list-group-item p-1" ><i class="la la-phone"></i> Overview</a>
                                    <a href="#" id="email" class="list-group-item p-1"><i class="la la-paper-plane"></i> Email</a>
                                    <a href="#" id="activity" class="list-group-item p-1"><i class="la la-venus"></i> Task</a>
                                    <a href="#" id="score" class="list-group-item p-1"> <i class="la la-gift"></i> Calender</a>
                                </div>
                            </div>
                        </div>
                        <div class="col-xl-6 col-lg-7 col-md-8 col-12">
                            <div class="card" id="transaction_card">
                               {{-- @if ($errors->any())
                                ...
                                <div class="card-content collapse show">
                                    <div class="card-body">
                                        <form method="post" class="form-horizontal"  id="addscore" novalidate>
                                            <input type="hidden" id="customerId" name="customerId">
                                            @csrf
                                            <div class="form-body skin skin-square">

                                                <fieldset>
                                                    <input type="radio" name="inputmethod" id="manual" value="0" checked>
                                                    <label for="manual">{{__('message.operation.add.transaction.inputmethod.manual')}}</label>
                                                </fieldset>
                                                <fieldset>
                                                    <input type="radio" name="inputmethod" id="automate" value="1" >
                                                    <label for="automate">{{__('message.operation.add.transaction.inputmethod.automate')}}</label>
                                                </fieldset>
                                                <div class="form-group">
                                                    <h5>{{__('message.operation.add.transaction.value')}}
                                                        <span class="required">*</span>
                                                    </h5>
                                                    {{--<label for="eventRegInput1">{{__('message.name')}}</label>--}}
                                                    <div class="controls">
                                                        <input type="number"  id="score" class="form-control"   placeholder="{{__('message.operation.add.transaction.value')}}" data-validation-required-message="{{__('message.required')}}" name="score">
                                                        <div class="help-block"></div>
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                                    <h5>{{__('message.operation.add.transaction.description')}}
                                                ...
                                                <fieldset>
                                                    <input type="checkbox" id="pscore" name="pscore">
                                                    <label for="pscore">{{__('message.operation.add.transaction.presentScore')}}</label>
                                                </fieldset>
                                            </div>
...
{{--    <script src="{{ URL::asset('app-assets/vendors/js/forms/extended/inputmask/jquery.inputmask.bundle.min.js') }}" type="text/javascript"></script>
   ...
   {{-- <script type="text/javascript" src="{{ URL::asset('app-assets/js/scripts/forms/select/form-select2.js')}}" ></script>
    ...
    <script type="text/javascript" src="{{ URL::asset('app-assets/js/scripts/blades/customeraddtransaction.js')}}" ></script>
    <!-- END PAGE LEVEL JS-->
