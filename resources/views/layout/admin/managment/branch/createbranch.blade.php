                            ...
                            <div class="card">
                                ...
                                <div class="card-content collapse show">
                                    <div class="card-body">
                                        ...
                                        <form method="post" class="form-horizontal" action="{{route('branch.store')}}" id="createbranch" novalidate>
                                            @csrf
                                            <div class="form-body">
                                                <div class="form-group">
                                                    ...
                                                    <div class="controls">
                                                    <input type="text" required  id="eventRegInput1" class="form-control" placeholder="{{__('message.name')}}" name="name"  data-validation-required-message="{{__('message.required')}}">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    {{--<label for="eventRegInput1">{{__('message.name')}}</label>--}}
                                                    <div class="controls">
                                                        <input type="text" required  data-validation-regex-regex="([a-z0-9_\.-]+)@([\da-z\.-]+)\.([a-z\.]{2,6})" data-validation-regex-message="{{__('message.validemail')}}" id="eventRegInput2" class="form-control" placeholder="{{__('message.email')}}" name="email" data-validation-required-message="{{__('message.required')}}">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    {{--<label for="eventRegInput1">{{__('message.name')}}</label>--}}
                                                    <div class="controls">
                                                        <input type="text"  id="eventRegInput3" class="form-control"  required placeholder="{{__('message.address')}}" data-validation-required-message="{{__('message.required')}}" name="address">
                                                        <div class="help-block"></div>
                                                    </div>
                                                </div>
                                            </div>
